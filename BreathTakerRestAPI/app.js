...
const articles = [
    { id: 1, title: 'How to use the app?', text_read: '5 min read', icon_name : 'ic_slash', content : [
    ...
    { id: 2, title: 'How to breath correctly?', text_read: '5 min read', icon_name : 'ic_arrow', content : [
